...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-8TRX7MLj.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-CxLcJKgD.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-C0WIBmEv.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-C8p3xvXt.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DLiR9rSy.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BGA9l2uc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-qNR40D_B.mjs'));
